...
import {
  BsGithub, BsLinkedin, BsPerson, BsInstagram,
} from 'react-icons/bs';
...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard('dev.cattarinich@gmail.com');
  const [showForm, setShowForm] = React.useState(true);
  const wg = useColorModeValue('white', 'gray.700');
  const gw = useColorModeValue('gray.700', 'whiteAlpha.900');
  ...
  const isNameError = formik.errors.name;
  const isEmailError = formik.errors.email;
  const isMessageError = formik.errors.message;
  return (
    <Flex
          ...
          >
            ...
            >
              ...
              >
                ...
                <Link href="https://github.com/delCatta">
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://instagram.com/diego.cclavel">
                  <IconButton
                    aria-label="twitter"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://cl.linkedin.com/in/diego-cclavel">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
                    ...
                    <VStack spacing={5}>
                      ...
                      <FormControl isRequired isInvalid={isNameError}>
                        ...
                        <InputGroup>
                          ...
                          <Input type="text" name="name" placeholder="Your Name" onChange={formik.handleChange} value={formik.values.name} />
                        </InputGroup>
                        {isNameError && (
                      ...
                      <FormControl isRequired isInvalid={isMessageError}>
                        ...
                        />
                        {isMessageError && (
                          <FormErrorMessage>A valid message is required.</FormErrorMessage>
                        )}
                      </FormControl>

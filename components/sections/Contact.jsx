...
export default function ContactFormWithSocialButtons() {
  ...
  var isNameError = formik.errors.name;
  var isEmailError = formik.errors.email;
  var isMessageError = formik.errors.message;
  return (
    <Flex
                ...
                <form onSubmit={formik.handleSubmit}>
                  <VStack spacing={5}>
                    ...
                    <FormControl isRequired isInvalid={isEmailError}>
                      ...
                      {!isEmailError ? (
                        <FormHelperText>Do not worry... I&apos;ll never share your email!</FormHelperText>
                      ) : (

        ...
        <Flex direction="column" alignSelf="center">
          ...
          >
            <Heading
              ...
              lineHeight="110%"
            >
              Diego Cattarinich Clavel <br />
              <Text as="span" color="teal.400">
                Full Stack Developer
              </Text>
            </Heading>
            <Text color={useColorModeValue("gray.600", "gray.400")}>
              A passionate full stack software developer specializing in mobile
              and web applications. With a solid background in computer software
              engineering and hands-on experience building efficient and
            ...
            >
              ...
              <a target="_blank" href="https://github.com/delcatta">
                <Button
                  colorScheme="teal"
                  bg="teal.400"
                  rounded="full"
